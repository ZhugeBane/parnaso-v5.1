...
interface DashboardProps {
  ...
  onHelp?: () => void; // Added Prop for Help Page
  readOnly?: boolean;
}
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <span className={`px-2 py-1 rounded-full text-xs font-semibold ${session.sessionRating >= 4 ? 'bg-emerald-100 text-emerald-700' :
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {TROPHIES.map(trophy => {
            ...
            return (
              <div
                key={trophy.id}
                className={`relative overflow-hidden rounded-2xl p-6 flex flex-col items-center text-center transition-all duration-300 border ${unlocked
